 ...
 * @memberof uiWindow
 */
_UI_EXTERN int uiWindowKeepInFront(const uiWindow *w);

/**
 * Sets whether or not the window is kept in front of other windows.
 *
 * @param w uiWindow instance.
 * @param keepInFront `TRUE` to keep window in front of others, `FALSE` otherwise.
 * @note This method is merely a hint and may be ignored by the system.
 * @memberof uiWindow
 */
_UI_EXTERN void uiWindowSetKeepInFront(uiWindow *w, int keepInFront);
